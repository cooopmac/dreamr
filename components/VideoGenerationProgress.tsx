...
export default function VideoGenerationProgressComponent({
    progress,
    visible,
    ...
    useEffect(() => {
        if (progress.status === VideoGenerationStatus.GENERATING) {
    ...
    const getIcon = () => {
        switch (progress.status) {
            ...
            default:
                return <Ionicons name="videocam" size={24} color="#6B7280" />;
        }
    };
            ...
            <View style={[styles.card, { borderColor: getBorderColor() }]}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.textContainer}>
                        ...
                        {/* Progress bar and details for generating state */}
                        {showProgressBar && (
